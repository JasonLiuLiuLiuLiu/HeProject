...
{
    public class S33P4Handle : IP4Handler
    {
            ...
            try
            {
                ...
                for (int i = 1; i < 7; i++)
                {
                    ...
                    for (int j = 0; j < 4; j++)
                    {
                        ...
                        resultDic[i][j] = context.GetP4RowResult(i + 18, row - j);
                    }
                }
                ...
                context.SetP4Value(33, row, 0, result[0]);
                context.SetP4Value(33, row, 1, result[1]);
                context.SetP4Value(33, row, 2, result[2]);
