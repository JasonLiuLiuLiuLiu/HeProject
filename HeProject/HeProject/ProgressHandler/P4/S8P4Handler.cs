...
{
    class S8P4Handler : IP4Handler
    {
        public string Hnalder(int row, ProcessContext context)
        {
            var p6Result = context.GetP4RowResult(6, row);
            ...
            context.SetP4Value(8, row, 0, c1);
            context.SetP4Value(8, row, 1, c2);
            context.SetP4Value(8, row, 2, c3);
            return null;
        }
    }
}
